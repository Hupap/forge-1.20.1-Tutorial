...
import net.jannik.tutorial.item.custom.FuelItem;
import net.jannik.tutorial.item.custom.MetalDetectorItem;
import net.jannik.tutorial.item.custom.ModArmorItem;
